export const booking = {
	...
	confirmPaymentMessage: 'Are you sure you want to pay {amount}?',
	confirmPaymentNote: 'The amount will be charged to your card as soon as you confirm.',
	confirmPaymentBack: 'Back',
	confirmPaymentPay: 'Pay {amount}',
