export const admin = {
	...
	validation: {
		...
		meetingLocationRequired: 'Enter a meeting point',
		categoryRequired: 'Choose a category',
		translationRequired: 'Add at least one language: Ru, En or Hy',
		...
		occurrenceRequired: 'Add at least one date',
		dateRequired: 'Choose a date and time',
		mustBeNumber: 'Enter a number',
		hoursMin: 'At least 1 hour',
		...
		userRequired: 'Choose a user or enter a new user\'s name',
		noAvailableDates: 'This event has no upcoming dates open for booking',
