export const admin = {
	...
	noSnapshotsForRange: 'No snapshots for this range',
	noSnapshotsExplanation: 'State is frozen once a day. Days before this feature was switched on were never recorded and cannot be reconstructed.',
