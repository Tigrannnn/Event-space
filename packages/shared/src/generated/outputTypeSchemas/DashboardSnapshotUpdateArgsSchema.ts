...
export const DashboardSnapshotUpdateArgsSchema: z.ZodType<Prisma.DashboardSnapshotUpdateArgs> = z.object({
  select: DashboardSnapshotSelectSchema.optional(),
  data: z.union([ DashboardSnapshotUpdateInputSchema, DashboardSnapshotUncheckedUpdateInputSchema ]),
  where: DashboardSnapshotWhereUniqueInputSchema, 
}).strict();

export default DashboardSnapshotUpdateArgsSchema;
