...
export const EventOccurrenceFindFirstArgsSchema: z.ZodType<Prisma.EventOccurrenceFindFirstArgs> = z.object({
...
export default EventOccurrenceFindFirstArgsSchema;
