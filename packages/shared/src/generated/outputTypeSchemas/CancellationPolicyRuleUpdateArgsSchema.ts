...
export const CancellationPolicyRuleUpdateArgsSchema: z.ZodType<Prisma.CancellationPolicyRuleUpdateArgs> = z.object({
  select: CancellationPolicyRuleSelectSchema.optional(),
  include: z.lazy(() => CancellationPolicyRuleIncludeSchema).optional(),
  data: z.union([ CancellationPolicyRuleUpdateInputSchema, CancellationPolicyRuleUncheckedUpdateInputSchema ]),
  where: CancellationPolicyRuleWhereUniqueInputSchema, 
}).strict();

export default CancellationPolicyRuleUpdateArgsSchema;
