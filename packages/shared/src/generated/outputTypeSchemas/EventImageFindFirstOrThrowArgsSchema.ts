...
export const EventImageFindFirstOrThrowArgsSchema: z.ZodType<Prisma.EventImageFindFirstOrThrowArgs> = z.object({
...
export default EventImageFindFirstOrThrowArgsSchema;
