...
export const DashboardSnapshotFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.DashboardSnapshotFindUniqueOrThrowArgs> = z.object({
  select: DashboardSnapshotSelectSchema.optional(),
  where: DashboardSnapshotWhereUniqueInputSchema, 
}).strict();

export default DashboardSnapshotFindUniqueOrThrowArgsSchema;
