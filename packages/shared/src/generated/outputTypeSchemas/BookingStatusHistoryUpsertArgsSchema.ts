...
export const BookingStatusHistoryUpsertArgsSchema: z.ZodType<Prisma.BookingStatusHistoryUpsertArgs> = z.object({
  ...
  create: z.union([ BookingStatusHistoryCreateInputSchema, BookingStatusHistoryUncheckedCreateInputSchema ]),
  update: z.union([ BookingStatusHistoryUpdateInputSchema, BookingStatusHistoryUncheckedUpdateInputSchema ]),
}).strict();

export default BookingStatusHistoryUpsertArgsSchema;
