...
export const DashboardSnapshotFindUniqueArgsSchema: z.ZodType<Prisma.DashboardSnapshotFindUniqueArgs> = z.object({
  select: DashboardSnapshotSelectSchema.optional(),
  where: DashboardSnapshotWhereUniqueInputSchema, 
}).strict();

export default DashboardSnapshotFindUniqueArgsSchema;
