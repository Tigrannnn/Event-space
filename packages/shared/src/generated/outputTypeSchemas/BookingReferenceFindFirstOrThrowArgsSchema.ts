...
export const BookingReferenceFindFirstOrThrowArgsSchema: z.ZodType<Prisma.BookingReferenceFindFirstOrThrowArgs> = z.object({
...
export default BookingReferenceFindFirstOrThrowArgsSchema;
