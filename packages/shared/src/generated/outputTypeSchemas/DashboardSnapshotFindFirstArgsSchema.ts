...
export const DashboardSnapshotFindFirstArgsSchema: z.ZodType<Prisma.DashboardSnapshotFindFirstArgs> = z.object({
...
export default DashboardSnapshotFindFirstArgsSchema;
