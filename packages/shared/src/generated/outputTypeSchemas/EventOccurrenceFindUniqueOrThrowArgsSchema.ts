...
export const EventOccurrenceFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.EventOccurrenceFindUniqueOrThrowArgs> = z.object({
...
export default EventOccurrenceFindUniqueOrThrowArgsSchema;
