...
export const BookingReferenceFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.BookingReferenceFindUniqueOrThrowArgs> = z.object({
  select: BookingReferenceSelectSchema.optional(),
  where: BookingReferenceWhereUniqueInputSchema, 
}).strict();

export default BookingReferenceFindUniqueOrThrowArgsSchema;
