...
import { BookingAdjustmentUpdateInputSchema } from '../inputTypeSchemas/BookingAdjustmentUpdateInputSchema'
import { BookingAdjustmentUncheckedUpdateInputSchema } from '../inputTypeSchemas/BookingAdjustmentUncheckedUpdateInputSchema'
...
export const BookingAdjustmentUpsertArgsSchema: z.ZodType<Prisma.BookingAdjustmentUpsertArgs> = z.object({
  ...
  create: z.union([ BookingAdjustmentCreateInputSchema, BookingAdjustmentUncheckedCreateInputSchema ]),
  update: z.union([ BookingAdjustmentUpdateInputSchema, BookingAdjustmentUncheckedUpdateInputSchema ]),
}).strict();

export default BookingAdjustmentUpsertArgsSchema;
