...
export const EventOccurrenceFindUniqueArgsSchema: z.ZodType<Prisma.EventOccurrenceFindUniqueArgs> = z.object({
...
export default EventOccurrenceFindUniqueArgsSchema;
