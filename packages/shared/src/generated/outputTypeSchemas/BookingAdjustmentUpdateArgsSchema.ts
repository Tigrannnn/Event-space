...
export const BookingAdjustmentUpdateArgsSchema: z.ZodType<Prisma.BookingAdjustmentUpdateArgs> = z.object({
  select: BookingAdjustmentSelectSchema.optional(),
  include: z.lazy(() => BookingAdjustmentIncludeSchema).optional(),
  data: z.union([ BookingAdjustmentUpdateInputSchema, BookingAdjustmentUncheckedUpdateInputSchema ]),
  where: BookingAdjustmentWhereUniqueInputSchema, 
}).strict();

export default BookingAdjustmentUpdateArgsSchema;
