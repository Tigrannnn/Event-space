...
export const BookingReferenceFindManyArgsSchema: z.ZodType<Prisma.BookingReferenceFindManyArgs> = z.object({
...
export default BookingReferenceFindManyArgsSchema;
