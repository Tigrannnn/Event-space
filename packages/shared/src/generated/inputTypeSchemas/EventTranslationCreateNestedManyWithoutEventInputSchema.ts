...
export const EventTranslationCreateNestedManyWithoutEventInputSchema: z.ZodType<Prisma.EventTranslationCreateNestedManyWithoutEventInput> = z.strictObject({
