...
export const OutboxEventUncheckedCreateInputSchema: z.ZodType<Prisma.OutboxEventUncheckedCreateInput> = z.object({
  id: z.cuid().optional(),
  action: z.string(),
...
export default OutboxEventUncheckedCreateInputSchema;
