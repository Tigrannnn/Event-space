...
import { NestedEnumEventOccurrenceStatusWithAggregatesFilterSchema } from './NestedEnumEventOccurrenceStatusWithAggregatesFilterSchema';
import { NestedIntFilterSchema } from './NestedIntFilterSchema';
import { NestedEnumEventOccurrenceStatusFilterSchema } from './NestedEnumEventOccurrenceStatusFilterSchema';

export const EnumEventOccurrenceStatusWithAggregatesFilterSchema: z.ZodType<Prisma.EnumEventOccurrenceStatusWithAggregatesFilter> = z.strictObject({
...
export default EnumEventOccurrenceStatusWithAggregatesFilterSchema;
