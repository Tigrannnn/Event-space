...
export const OutboxEventUncheckedUpdateInputSchema: z.ZodType<Prisma.OutboxEventUncheckedUpdateInput> = z.object({
...
export default OutboxEventUncheckedUpdateInputSchema;
