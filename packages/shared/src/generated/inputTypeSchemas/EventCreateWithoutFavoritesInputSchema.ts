...
export const EventCreateWithoutFavoritesInputSchema: z.ZodType<Prisma.EventCreateWithoutFavoritesInput> = z.strictObject({
  id: z.uuid().optional(),
...
export default EventCreateWithoutFavoritesInputSchema;
