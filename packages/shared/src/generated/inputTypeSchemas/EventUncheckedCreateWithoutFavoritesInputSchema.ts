...
export const EventUncheckedCreateWithoutFavoritesInputSchema: z.ZodType<Prisma.EventUncheckedCreateWithoutFavoritesInput> = z.strictObject({
  id: z.uuid().optional(),
...
export default EventUncheckedCreateWithoutFavoritesInputSchema;
