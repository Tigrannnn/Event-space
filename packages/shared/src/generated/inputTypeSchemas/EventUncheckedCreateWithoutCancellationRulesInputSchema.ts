...
export const EventUncheckedCreateWithoutCancellationRulesInputSchema: z.ZodType<Prisma.EventUncheckedCreateWithoutCancellationRulesInput> = z.strictObject({
  id: z.uuid().optional(),
