...
export const EventUpdateWithoutImagesInputSchema: z.ZodType<Prisma.EventUpdateWithoutImagesInput> = z.strictObject({
...
export default EventUpdateWithoutImagesInputSchema;
