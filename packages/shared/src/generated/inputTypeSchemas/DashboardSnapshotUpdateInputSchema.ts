...
export const DashboardSnapshotUpdateInputSchema: z.ZodType<Prisma.DashboardSnapshotUpdateInput> = z.strictObject({
...
export default DashboardSnapshotUpdateInputSchema;
