...
export const EventCreateWithoutTranslationsInputSchema: z.ZodType<Prisma.EventCreateWithoutTranslationsInput> = z.strictObject({
  id: z.uuid().optional(),
...
export default EventCreateWithoutTranslationsInputSchema;
