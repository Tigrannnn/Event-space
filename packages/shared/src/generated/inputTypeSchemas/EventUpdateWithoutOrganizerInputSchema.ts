...
export const EventUpdateWithoutOrganizerInputSchema: z.ZodType<Prisma.EventUpdateWithoutOrganizerInput> = z.object({
...
export default EventUpdateWithoutOrganizerInputSchema;
