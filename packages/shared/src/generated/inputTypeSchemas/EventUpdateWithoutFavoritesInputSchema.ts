...
export const EventUpdateWithoutFavoritesInputSchema: z.ZodType<Prisma.EventUpdateWithoutFavoritesInput> = z.strictObject({
...
export default EventUpdateWithoutFavoritesInputSchema;
