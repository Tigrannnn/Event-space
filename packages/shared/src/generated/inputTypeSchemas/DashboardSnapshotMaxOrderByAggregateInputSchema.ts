...
export const DashboardSnapshotMaxOrderByAggregateInputSchema: z.ZodType<Prisma.DashboardSnapshotMaxOrderByAggregateInput> = z.strictObject({
...
export default DashboardSnapshotMaxOrderByAggregateInputSchema;
