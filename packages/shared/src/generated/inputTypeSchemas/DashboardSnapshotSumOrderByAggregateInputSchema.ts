...
export const DashboardSnapshotSumOrderByAggregateInputSchema: z.ZodType<Prisma.DashboardSnapshotSumOrderByAggregateInput> = z.strictObject({
...
export default DashboardSnapshotSumOrderByAggregateInputSchema;
