...
export const EventUpdateWithoutTranslationsInputSchema: z.ZodType<Prisma.EventUpdateWithoutTranslationsInput> = z.strictObject({
...
export default EventUpdateWithoutTranslationsInputSchema;
