...
export const BookingAdjustmentUncheckedCreateInputSchema: z.ZodType<Prisma.BookingAdjustmentUncheckedCreateInput> = z.strictObject({
  id: z.uuid().optional(),
  bookingId: z.string(),
...
export default BookingAdjustmentUncheckedCreateInputSchema;
