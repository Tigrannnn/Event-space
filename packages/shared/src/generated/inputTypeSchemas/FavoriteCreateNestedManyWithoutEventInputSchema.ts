...
export const FavoriteCreateNestedManyWithoutEventInputSchema: z.ZodType<Prisma.FavoriteCreateNestedManyWithoutEventInput> = z.strictObject({
...
export default FavoriteCreateNestedManyWithoutEventInputSchema;
