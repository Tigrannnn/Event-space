...
export const DashboardSnapshotCreateManyInputSchema: z.ZodType<Prisma.DashboardSnapshotCreateManyInput> = z.strictObject({
  date: z.coerce.date(),
...
export default DashboardSnapshotCreateManyInputSchema;
